...
const Size9kg = () => {
  ...
  const Size9kgCakes = products.filter((product) =>
    product.ProductSize.includes("9kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size9kgCakes.length !== 0 && <h1>Size 9 KG Cakes</h1>}
      <div className="products-container">
        {Size9kgCakes.length === 0 && <p>No Size 9 KG cakes to display</p>}
        {Size9kgCakes.map((product) => (
