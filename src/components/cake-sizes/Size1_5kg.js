...
const Size1_5kg = () => {
  ...
  const Size1_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("1.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size1_5kgCakes.length !== 0 && <h1>Size 1.5 KG Cakes</h1>}
      <div className="products-container">
        {Size1_5kgCakes.length === 0 && <p>No Size 1.5 KG cakes to display</p>}
        {Size1_5kgCakes.map((product) => (
