...
const Size4_5kg = () => {
  ...
  const Size4_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("4.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size4_5kgCakes.length !== 0 && <h1>Size 4.5 KG Cakes</h1>}
      <div className="products-container">
        {Size4_5kgCakes.length === 0 && <p>No Size 4.5 KG cakes to display</p>}
        {Size4_5kgCakes.map((product) => (
