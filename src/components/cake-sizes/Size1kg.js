...
const Size1kg = () => {
  ...
  const Size1kgCakes = products.filter(
    (product) => product.ProductSize && product.ProductSize.includes("1kg")
  );
  const createWhatsappMessage = (productName, productImg) => {
    const message = `I want to purchase ${productName} at size ${selectedSize} for ${selectedDate} my address is ${location} and my Alternate Number is ${alternateNumber}`;
  ...
  return (
    <>
      <Header />
      <br />
      {Size1kgCakes.length !== 0 && <h1>Size 1 KG Cakes</h1>}
      <div className="products-container">
        {Size1kgCakes.length === 0 && <p>No Size 1 KG cakes to display</p>}
        {Size1kgCakes.map((product) => (
          <div className="product-card" key={product.ProductID}>
            ...
            <div className="product-details">
              ...
              <input
                ...
                className="alternate-nu   mber-input"
              />
