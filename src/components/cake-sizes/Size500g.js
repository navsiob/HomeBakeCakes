...
const Size500g = () => {
  ...
  const Size500gCakes = products.filter((product) =>
    product.ProductSize.includes("500g")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size500gCakes.length !== 0 && <h1>Size 500 gram Cakes</h1>}
      <div className="products-container">
        {Size500gCakes.length === 0 && <p>No Size 500 gram cakes to display</p>}
        {Size500gCakes.map((product) => (
