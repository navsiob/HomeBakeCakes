...
const Size2kg = () => {
  ...
  const Size2kgCakes = products.filter((product) =>
    product.ProductSize.includes("2kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size2kgCakes.length !== 0 && <h1>Size 2 KG Cakes</h1>}
      <div className="products-container">
        {Size2kgCakes.length === 0 && <p>No Size 2 KG cakes to display</p>}
        {Size2kgCakes.map((product) => (
