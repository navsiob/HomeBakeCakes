...
const Size7kg = () => {
  ...
  const Size7kgCakes = products.filter((product) =>
    product.ProductSize.includes("7kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size7kgCakes.length !== 0 && <h1>Size 7 KG Cakes</h1>}
      <div className="products-container">
        {Size7kgCakes.length === 0 && <p>No Size 7 KG cakes to display</p>}
        {Size7kgCakes.map((product) => (
