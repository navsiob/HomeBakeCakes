...
const Size10kg = () => {
  ...
  const Size10kgCakes = products.filter((product) =>
    product.ProductSize.includes("10kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size10kgCakes.length !== 0 && <h1>Size 10 KG Cakes</h1>}
      <div className="products-container">
        {Size10kgCakes.length === 0 && <p>No Size 10 KG cakes to display</p>}
        {Size10kgCakes.map((product) => (
