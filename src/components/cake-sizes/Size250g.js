...
const Size250g = () => {
  ...
  const Size250gCakes = products.filter((product) =>
    product.ProductSize.includes("250g")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size250gCakes.length !== 0 && <h1>Size 250 gram Cakes</h1>}
      <div className="products-container">
        {Size250gCakes.length === 0 && (
          <p>No Size 250 gram KG cakes to display</p>
        )}
        {Size250gCakes.map((product) => (
