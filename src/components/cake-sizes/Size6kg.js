...
const Size6kg = () => {
  ...
  const Size6kgCakes = products.filter((product) =>
    product.ProductSize.includes("6kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size6kgCakes.length !== 0 && <h1>Size 6 KG Cakes</h1>}
      <div className="products-container">
        {Size6kgCakes.length === 0 && <p>No Size 6 KG cakes to display</p>}
        {Size6kgCakes.map((product) => (
