...
const Size5_5kg = () => {
  ...
  const Size5_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("5.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size5_5kgCakes.length !== 0 && <h1>Size 5.5 KG Cakes</h1>}
      <div className="products-container">
        {Size5_5kgCakes.length === 0 && <p>No Size 5.5 KG cakes to display</p>}
        {Size5_5kgCakes.map((product) => (
