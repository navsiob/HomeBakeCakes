...
const Size9_5kg = () => {
  ...
  const Size9_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("9.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size9_5kgCakes.length !== 0 && <h1>Size 9.5 KG Cakes</h1>}
      <div className="products-container">
        {Size9_5kgCakes.length === 0 && <p>No Size 9.5 KG cakes to display</p>}
        {Size9_5kgCakes.map((product) => (
