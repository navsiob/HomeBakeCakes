...
const Size3_5kg = () => {
  ...
  const Size3_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("3.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size3_5kgCakes.length !== 0 && <h1>Size 3.5 KG Cakes</h1>}
      <div className="products-container">
        {Size3_5kgCakes.length === 0 && <p>No Size 3.5 KG cakes to display</p>}
        {Size3_5kgCakes.map((product) => (
