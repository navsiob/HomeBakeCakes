...
const Size8kg = () => {
  ...
  const Size8kgCakes = products.filter((product) =>
    product.ProductSize.includes("8kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size8kgCakes.length !== 0 && <h1>Size 8 KG Cakes</h1>}
      <div className="products-container">
        {Size8kgCakes.length === 0 && <p>No Size 8 KG cakes to display</p>}
        {Size8kgCakes.map((product) => (
