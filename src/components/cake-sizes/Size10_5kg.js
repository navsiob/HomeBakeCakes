...
const Size10_5kg = () => {
  ...
  const Size10_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("10.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size10_5kgCakes.length !== 0 && <h1>Size 10.5 KG Cakes</h1>}
      <div className="products-container">
        {Size10_5kgCakes.length === 0 && (
          <p>No Size 10.5 KG cakes to display</p>
        )}
        {Size10_5kgCakes.map((product) => (
