...
const Size4kg = () => {
  ...
  const Size4kgCakes = products.filter((product) =>
    product.ProductSize.includes("4kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size4kgCakes.length !== 0 && <h1>Size 4 KG Cakes</h1>}
      <div className="products-container">
        {Size4kgCakes.length === 0 && <p>No Size 4 KG cakes to display</p>}
        {Size4kgCakes.map((product) => (
