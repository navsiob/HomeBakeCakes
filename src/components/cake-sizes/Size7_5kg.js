...
const Size7_5kg = () => {
  ...
  const Size7_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("7.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size7_5kgCakes.length !== 0 && <h1>Size 7.5 KG Cakes</h1>}
      <div className="products-container">
        {Size7_5kgCakes.length === 0 && <p>No Size 7.5 KG cakes to display</p>}
        {Size7_5kgCakes.map((product) => (
