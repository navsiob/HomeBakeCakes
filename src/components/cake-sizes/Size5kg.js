...
const Size5kg = () => {
  ...
  const Size5kgCakes = products.filter((product) =>
    product.ProductSize.includes("5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size5kgCakes.length !== 0 && <h1>Size 5 KG Cakes</h1>}
      <div className="products-container">
        {Size5kgCakes.length === 0 && <p>No Size 5 KG cakes to display</p>}
        {Size5kgCakes.map((product) => (
