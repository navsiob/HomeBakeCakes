...
const Size6_5kg = () => {
  ...
  const Size6_5kgCakes = products.filter((product) =>
    product.ProductSize.includes("6.5kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size6_5kgCakes.length !== 0 && <h1>Size 6.5 KG Cakes</h1>}
      <div className="products-container">
        {Size6_5kgCakes.length === 0 && <p>No Size 6.5 KG cakes to display</p>}
        {Size6_5kgCakes.map((product) => (
