...
const Size3kg = () => {
  ...
  const Size3kgCakes = products.filter((product) =>
    product.ProductSize.includes("3kg")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {Size3kgCakes.length !== 0 && <h1>Size 3 KG Cakes</h1>}
      <div className="products-container">
        {Size3kgCakes.length === 0 && <p>No Size 3 KG cakes to display</p>}
        {Size3kgCakes.map((product) => (
