...
const CupCake = () => {
  ...
  const CupCakes = products.filter((product) =>
    product.ProductCategory.includes("Cup-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {CupCakes.length !== 0 && <h1>Cup Cakes</h1>}
      <div className="products-container">
        {CupCakes.length === 0 && <p>No Cup cakes to display</p>}
