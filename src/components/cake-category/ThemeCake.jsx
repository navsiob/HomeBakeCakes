...
const ThemeCake = () => {
  ...
  const ThemeCakes = products.filter((product) =>
    product.ProductCategory.includes("Theme-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {ThemeCakes.length !== 0 && <h1>Theme Cakes</h1>}
      <div className="products-container">
        {ThemeCakes.length === 0 && <p>No Theme cakes to display</p>}
        {ThemeCakes.map((product) => (
