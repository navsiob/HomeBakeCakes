...
const AnniversaryCake = () => {
  ...
  const AnniversaryCakes = products.filter((product) =>
    product.ProductCategory.includes("Anniversary-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {AnniversaryCakes.length !== 0 && <h1>Anniversary Cakes</h1>}
      <div className="products-container">
        {AnniversaryCakes.length === 0 && (
          <p>No Anniversary cakes to display</p>
        )}
        {AnniversaryCakes.map((product) => (
