...
const SugarFreeCake = () => {
  ...
  const SugarFreeCakes = products.filter((product) =>
    product.ProductCategory.includes("Sugar-Free-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {SugarFreeCakes.length !== 0 && <h1>Sugar Free Cakes</h1>}
      <div className="products-container">
        {SugarFreeCakes.length === 0 && <p>No Sugar Free cakes to display</p>}
        {SugarFreeCakes.map((product) => (
