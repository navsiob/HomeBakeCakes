...
const CustomizedChocolate = () => {
  ...
  const CustomizedChocolate = products.filter((product) =>
    product.ProductCategory.includes("customized-chocolate")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {CustomizedChocolate.length !== 0 && <h1>Customized Chocolates</h1>}
      <div className="products-container">
        {CustomizedChocolate.length === 0 && (
          <p>No Customized Chocolates to display</p>
        )}
        {CustomizedChocolate.map((product) => (
