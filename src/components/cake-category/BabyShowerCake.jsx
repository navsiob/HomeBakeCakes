...
const BabyShowerCake = () => {
  ...
  const BabyShowerCakes = products.filter((product) =>
    product.ProductCategory.includes("Baby-Shower-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {BabyShowerCakes.length !== 0 && <h1>Baby Shower Cakes</h1>}
      <div className="products-container">
        {BabyShowerCakes.length === 0 && <p>No Baby Shower cakes to display</p>}
        {BabyShowerCakes.map((product) => (
