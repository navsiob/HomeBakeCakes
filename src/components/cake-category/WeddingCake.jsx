...
const WeddingCake = () => {
  ...
  const WeddingCakes = products.filter((product) =>
    product.ProductCategory.includes("Wedding-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {WeddingCakes.length !== 0 && <h1>Wedding Cakes</h1>}
      <div className="products-container">
        {WeddingCakes.length === 0 && <p>No Wedding cakes to display</p>}
