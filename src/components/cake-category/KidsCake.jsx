...
const KidsCake = () => {
  ...
  const KidsCakes = products.filter((product) =>
    product.ProductCategory.includes("Kids-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {KidsCakes.length !== 0 && <h1>Kids Cakes</h1>}
      <div className="products-container">
        {KidsCakes.length === 0 && <p>No Kids cakes to display</p>}
        {KidsCakes.map((product) => (
