...
const SixMonthCake = () => {
  ...
  const SixMonthCakes = products.filter((product) =>
    product.ProductCategory.includes("6-Month-birthday-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {SixMonthCakes.length !== 0 && <h1>Six Month Birthday Cakes</h1>}
      <div className="products-container">
        {SixMonthCakes.length === 0 && (
          <p>No Six Month Birthday cakes to display</p>
        )}
        {SixMonthCakes.map((product) => (
