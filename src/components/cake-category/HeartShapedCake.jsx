...
const HeartShapedCake = () => {
  ...
  const HeartShapedCakes = products.filter((product) =>
    product.ProductCategory.includes("Heart-Shaped-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {HeartShapedCakes.length !== 0 && <h1>Heart Shaped Cakes</h1>}
      <div className="products-container">
        {HeartShapedCakes.length === 0 && (
          <p>No Heart Shaped cakes to display</p>
        )}
        {HeartShapedCakes.map((product) => (
