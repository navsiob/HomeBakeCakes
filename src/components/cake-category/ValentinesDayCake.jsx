...
const ValentinesDayCake = () => {
  ...
  const ValentinesDayCakes = products.filter((product) =>
    product.ProductCategory.includes("Valentines-Day-Cakes")
  );
  ...
  return (
    <>
      <Header />
      <br />
      {ValentinesDayCakes.length !== 0 && <h1>ValentinesDay Cakes</h1>}
      <div className="products-container">
        {ValentinesDayCakes.length === 0 && (
          <p>No ValentinesDay cakes to display</p>
        )}
        {ValentinesDayCakes.map((product) => (
